    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="@themedir()/@theme()/img/carousel-1.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="@themedir()/@theme()/img/carousel-2.jpg" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
    ...
    <div class="container">
        <div class="row g-0 feature-row">
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                <div class="feature-item border h-100 p-5">
                    <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                        <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-1.png" alt="Icon">
                    </div>
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                <div class="feature-item border h-100 p-5">
                    <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                        <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-2.png" alt="Icon">
                    </div>
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                <div class="feature-item border h-100 p-5">
                    <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                        <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-3.png" alt="Icon">
                    </div>
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                <div class="feature-item border h-100 p-5">
                    <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                        <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-4.png" alt="Icon">
                    </div>
            ...
            <div class="col-lg-6 pt-lg-5 wow fadeIn" data-wow-delay="0.5s">
                <div class="bg-white rounded-top p-5 mt-lg-5">
                    ...
                    <div class="row g-5 pt-2 mb-5">
                        <div class="col-sm-6">
                            <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/icon/icon-5.png" alt="">
                            <h5 class="mb-3">Managed Services</h5>
                            <span>Clita erat ipsum et lorem et sit sed stet lorem</span>
                        </div>
                        <div class="col-sm-6">
                            <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/icon/icon-2.png" alt="">
        ...
        <div class="row g-4">
                ...
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-5.png" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-6.png" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-7.png" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-8.png" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-9.png" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 64px; height: 64px;">
                            <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/icon/icon-10.png" alt="Icon">
                        </div>
        ...
        <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="project-item mb-5">
                <div class="position-relative">
                    <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/project-1.jpg" alt="">
                    <div class="project-overlay">
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="@themedir()/@theme()/img/project-1.jpg" data-lightbox="project"><i class="fa fa-eye"></i></a>
            ...
            <div class="project-item mb-5">
                <div class="position-relative">
                    <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/project-2.jpg" alt="">
                    <div class="project-overlay">
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="@themedir()/@theme()/img/project-2.jpg" data-lightbox="project"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                    </div>
                </div>
                <div class="p-4">
            ...
            <div class="project-item mb-5">
                <div class="position-relative">
                    <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/project-3.jpg" alt="">
                    <div class="project-overlay">
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="@themedir()/@theme()/img/project-3.jpg" data-lightbox="project"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                    </div>
                </div>
                <div class="p-4">
            ...
            <div class="project-item mb-5">
                <div class="position-relative">
                    <img class="@themedir()/@theme()/img-fluid" src="@themedir()/@theme()/img/project-4.jpg" alt="">
                    <div class="project-overlay">
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="@themedir()/@theme()/img/project-4.jpg" data-lightbox="project"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                    </div>
                </div>
                <div class="p-4">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item rounded overflow-hidden pb-4">
                    <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/team-1.jpg" alt="">
                    <h5>Alex Robin</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item rounded overflow-hidden pb-4">
                    <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/team-2.jpg" alt="">
                    <h5>Adam Crew</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item rounded overflow-hidden pb-4">
                    <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/team-3.jpg" alt="">
                    <h5>Boris Johnson</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item rounded overflow-hidden pb-4">
                    <img class="@themedir()/@theme()/img-fluid mb-4" src="@themedir()/@theme()/img/team-4.jpg" alt="">
                    <h5>Robert Jordan</h5>
    ...
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                <img class="mb-4" src="@themedir()/@theme()/img/testimonial-1.jpg" alt="">
            ...
            <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                <img class="mb-4" src="@themedir()/@theme()/img/testimonial-2.jpg" alt="">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <h5>Client Name</h5>
                <span class="text-primary">Profession</span>
            </div>
            <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                <img class="mb-4" src="@themedir()/@theme()/img/testimonial-3.jpg" alt="">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <h5>Client Name</h5>
                <span class="text-primary">Profession</span>
            </div>
            <div class="testimonial-item rounded p-4 p-lg-5 mb-5">
                <img class="mb-4" src="@themedir()/@theme()/img/testimonial-4.jpg" alt="">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <h5>Client Name</h5>
                <span class="text-primary">Profession</span>
            </div>
