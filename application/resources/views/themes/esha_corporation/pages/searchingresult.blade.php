...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h3 class="section-title bg-white text-center text-primary px-3">SEARCHING RESULT</h3>
            ...
            @foreach($categories as $cat)
                <div class="col-12 col-lg-4 col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="service-item d-block rounded text-center h-100 p-4" href="{{URL::to('/')}}/productSubCategory/{{$cat->id}}">
                        <img class="@themedir()/@theme()/img-fluid rounded mb-4" src="{{URL::to('/')}}/application/storage/app/product/{{$cat->image}}" alt="" width='100%' height="auto">
