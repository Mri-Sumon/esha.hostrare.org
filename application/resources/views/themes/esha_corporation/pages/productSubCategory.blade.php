    ...
    <!--subCategory start here-->
        ...
        <div class="container-fluid py-5">
            <div class="container-fluid">
                <div class="mb-5">
                    <h3 class="bg-white text-center text-primary px-3">{{$categories->name}}</h3>
                </div>
                <div class="row g-4">
                    @foreach ($subCategories as $subCategory)
                        <div class="col-12 col-lg-4 col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="subCategory">
                                <a class="service-item d-block rounded text-center h-100 p-4" href="{{URL::to('/')}}/productSinglePage/{{$subCategory->id}}" style="padding: 0px !important;">
                                    <img class="@themedir()/@theme()/img-fluid rounded mb-4 mt-2" src="{{URL::to('/')}}/application/storage/app/product/{{$subCategory->image}}" alt="" width='100%' height="auto" style="margin: 0px !important; border-radius: 0px !important;">
                                    <div class="my-3">
